...
-- !! Run on an empty database: medicaldb				     !!
--    Consist of 3 parts: 1 - creating tables, 2 - filling tables, 3 - Checking data in the tables 
-- !! update ANY changes!						     !!
--    (drop the tables first If you want to create it again AND any OLD Tables already exists)
--    =====================================================================
...
-- =================================
-- 3. Checking (SELECT queries for checking every part of our database can be run by Blocks)
-- =================================
